...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Master of Computer Science (Applied Computing); N/A}{Sep. 2018 -- July 2020}
    \resumeSubheading
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Machine Intelligence Engineer}{Jan. 2019 - Present}
      \resumeItemListStart
        \resumeItem{Imaging Solutions}
          {3D scanner using laser line triangulation. It's purpose is to scan seedlings to study and pick the ones that grow the fastest. Plant phenotyping chamber which utilises Structure from Motion concepts (SfM) to capture a 3D model of a plant.}
